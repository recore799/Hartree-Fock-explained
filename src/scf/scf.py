...
if __name__ == "__main__":
    ...
    Z_h2 = (1.0,1.0)
    scf_rhf_s(primitives_h2, pos=pos_h2, R=1.4, Z=Z_h2, n_elec=2, R_nuc=pos_h2, Z_nuc=Z_h2, verbose=1)
    ...
    Z_heh = (2.0,1.0)
    scf_rhf_s(primitives_heh, pos=pos_heh, R=1.4632, Z=Z_heh, n_elec=2, R_nuc=pos_heh, Z_nuc=Z_heh, verbose=1)
