...
def build_Iac_old(params, I_A):
    ...
    # Initialize I(00|00), used in I(ab|c)
    I_AC[(0, (0,0,0), (0,0,0))] = I_A.get((0, (0,0,0)), 0.0)
...
# I_A = build_Ia01(params)
# I_AC = build_Iac1(params, I_A)
# end_time1 = time.time()
...
# print(f"Total runtime2: {end_time - start_time:.4f} seconds")



# Print results I_AC
# for k, v in I_AC.items():
#     print(f"new I^{k[0]}({k[1]}|{k[2]}) = {v:.5f}")



# script runs - have not validated results
...
# --- Test Setup ---
# Index of last tuple in previous shell s=0, p=1, d=2, f=3, g=4
N_SHELLS = {
    0: 0,   # s: (0,0,0)
    1: 0,    # s + p: (0,0,0), (1,0,0), (0,1,0), (0,0,1)
    2: 3,   # s + p + d: (0,0,0), ..., (2,0,0), ..., (0,0,2)
    3: 9,   # s + p + d + f
    4: 19,   # s + p + d + f + g
    5: 34,
}
